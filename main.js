...
class BasicWorldDemo {
  ...
  _Initialize() {
    ...
    this.camera_.position.set(-7, 7, 12);
    ...
    const ground = new THREE.Mesh(
        ...
        new THREE.MeshStandardMaterial({
            // color: 0xf6f47f,
            map: new THREE.TextureLoader().load("./resources/nature/sand2.jpg"),
          }));
    ...
    const uniforms = {
      topColor: { value: new THREE.Color(0x7D8A96) },
      bottomColor: { value: new THREE.Color(0xA5B7BD) },
  ...
  Step_(timeElapsed) {
    ...
    if (this.player_.gameOver && !this.gameOver_) {
      ...
      document.onclick = (msg) => location.reload();
    }
  }
}
